...
<div>
  ...
  <div class="ml-1 space-y-3 text-gray-700 dark:text-gray-200">
    <div class="flex items-center">
      ...
      <a href="mailto:karelfrederix@gmail.com">karelfrederix@gmail.com</a>
    </div>
    <div class="flex items-center">
      <span class="mr-3">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mx-0.5" viewBox="0 0 24 24" fill="currentColor">
